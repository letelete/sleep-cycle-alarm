...
public class WakeUpAtFragment extends Fragment
    ...
    public void showToast(DateTime definedHour) {
        Toast.makeText(getActivity(), "Couldn't generate a list with given hour("+ AlarmContentUtils.getTitle(definedHour) + ") There will be displayed the nearest hour to defined...", Toast.LENGTH_LONG).show();
    }
